...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class LeverUpDown : XRBaseInteractable
    {
        ...
        public UnityEvent<float> onLeverUpdate;
        ...
        void UpdateValue()
        {
            ...
            bool leverState = maxAngleDistance < minAngleDistance;

            SetHandleAngle(lookAngle);

            leverValue = Mathf.InverseLerp(m_MinAngle, m_MaxAngle, lookAngle);
            onLeverUpdate.Invoke(leverValue);
